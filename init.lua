...
do
  ...
  -- Apply the high-contrast dark version (or use 'modus_operandi' for light mode)
...
do
  ...
  require('telescope').setup {
    ...
    defaults = {
      mappings = {
        ...
        n = {
          ['j'] = actions.preview_scrolling_left,
          ['k'] = actions.preview_scrolling_down,
          ['l'] = actions.preview_scrolling_up,
  ...
  vim.keymap.set(
    'n',
    '<leader>sf',
    function() require('telescope.builtin').find_files { hidden = true, file_ignore_patterns = { '.git/' } } end,
    { desc = '[S]earch [F]iles' }
  )
  ...
  vim.keymap.set(
    ...
    { desc = '[S]earch [R]ecent files in current project' }
  )
